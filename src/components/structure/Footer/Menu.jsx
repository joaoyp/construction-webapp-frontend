...
export const Menu = () => {
  return (
    <div className="w-1/3 flex flex-col gap-1 items-center">
        ...
        <div className="hover:text-yellow-500">
            <FooterLink text="Portefólio" fontSize={18} color="white" to="/portefolio"/>
        </div>
        <div className="hover:text-yellow-500">
            <FooterLink text="Serviços" fontSize={18} color="white" to="/servicos"/>
        </div>
        <div className="hover:text-yellow-500">
            <FooterLink text="Contactos" fontSize={18} color="white" to="/contactos"/>
      </div>
    </div>
  );
};