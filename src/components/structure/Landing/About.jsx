...
export const About = () => {
    return (
        <div className="bg-white min-h-[70vh] flex items-center w-full max-md:flex-col">
            <img className="object-contain h-2/3 w-full m-10 max-md:m-4" src={AboutImage} alt="About Us" />
            <div className="flex flex-col w-full h-2/3 m-10 max-md:m-4">
                <div className="max-md:ml-4">
                    <Lettering fontSize={26} text={"Sobre Nós"} />
                </div>
                <div className="max-md:ml-4">
                    <Lettering color={"orange"} fontSize={40} text={"Pedro & Agostinho - Construções"} />
                </div>
                <div className="mt-4 mr-10 max-md:ml-4">
                ...
                <div className="w-fit text-orange-400 h-fit flex mt-4 max-md:ml-4">
                    <Link to="/contactos">
